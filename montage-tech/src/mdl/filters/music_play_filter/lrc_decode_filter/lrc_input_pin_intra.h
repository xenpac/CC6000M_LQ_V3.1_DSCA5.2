...
/********************************************************************************************/
#ifndef __LRC_INPUT_PIN_INTRA_H_
#define __LRC_INPUT_PIN_INTRA_H_


/*!
  lrc input pin private data
  */
typedef struct tag_lrc_input_pin_private
{
  /*!
    this point !!
    */
...
}lrc_in_pin_private_t;

/*!
  the lrc input pin
  */
typedef struct tag_lrc_in_pin
{
  /*!
  ...
  /*!
    private data buffer
    */
  lrc_in_pin_private_t private_data;
}lrc_in_pin_t;
...
/*!
  ...
  */
lrc_in_pin_t * lrc_in_pin_create(lrc_in_pin_t *p_pin, interface_t *p_owner);
