...
static const u16 iso6937_map_A8_BF[] =
{
...
static const u16 iso6937_map_D0_FF[] =
{
  0x2014, /*D0	EM DASH */
...
static const char_map_t iso6937_C2[] =
{
...
static const char_map_t iso6937_C6[] =
{
  {0x20, 0x02D8}, /* BREV */
...
static const char_map_t iso6937_CF[] =
{
...
static const char_map_t iso6937_CB[] =
{
  {0x20, 0x00B8}, /* CEDILL */
...
static const char_map_t iso6937_C3[] =
{
...
static const char_map_t iso6937_C8[] =
{
...
static const char_map_t iso6937_C7[] =
{
...
static const char_map_t iso6937_CD[] =
{
...
static const char_map_t iso6937_C1[] =
{
...
static const char_map_t iso6937_C5[] =
{
  {0x20, 0x00AF}, /* MACRO */
...
static const char_map_t iso6937_CE[] =
{
  {0x20, 0x02DB}, /* OGONE */
...
static const char_map_t iso6937_CA[] =
{
...
static const char_map_t iso6937_C4[] =
{
...
static const char_map_info_t iso6937_lookup_table[] =
{
  {iso6937_C1, 10},
  {iso6937_C2, 25},
  {iso6937_C3, 24},
...
{
  s32 si = 0, di = 0;
  u16 src = 0, value = 0, ctrlw = 0;

  CHECK_FAIL_RET_VOID(NULL != p_iso6937
            && 0 != length
            && NULL != p_unicode
            && 0 != maxlen);
  ...
  for(si = di = 0; (si < length) && (di < (maxlen -1)); si++)
  {
    ...
    if((src >= 0x80) && (src <= 0x9F))   /* control code, ignore them */
    {
      continue;
    }
    else if(src < 0xA8)    /* same value */
    {
      p_unicode[di++] = src;
    }
    else if(src <= 0xBF)    /* A8-BF table */
    {
      p_unicode[di++] = iso6937_map_A8_BF[src - 0xA8];
    }
    else if(src >= 0xD0)    /* D0-FF table */
    {
      p_unicode[di++] = iso6937_map_D0_FF[src - 0xD0];
    }
    /* 0xC1-0xCF combined code */
    else if((src != 0xC0) && (src != 0xC9) && (src != 0xCC))
    {
      ...
      else
      {
        ctrlw = src;
        src = p_iso6937[++si];
        value = map_lookup(src,
                           iso6937_lookup_table[ctrlw - 0xC1].p_table,
                           iso6937_lookup_table[ctrlw - 0xC1].count);
        if(value == 0xFFFF)
        {
          p_unicode[di++] = p_iso6937[si - 1];
          if(di < maxlen)
          {
            p_unicode[di++] = src;
          }
