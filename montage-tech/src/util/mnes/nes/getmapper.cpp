...
GetMapper(int mapper_num)
{
  ...
  //fprintf(stderr, "Creating NES MAPPER (%d)\n", mapper_num );
...
#if 0
  case 12: // "BTL REX DBZ5"
    return new NES_mapperNSF();
#endif

  case 184: // "SUNSOFT1(CN-ROM)"
    return new NES_mapper122();

//  case 163:	// Add by OopsWare, support "NANJING" rom
//	return new NES_mapper163();
	
  default:
    NES_PRINT("unsupported mapper\n");
