...
// NES_PPU::do_scanline_and_draw_bankswitch_per_tile (uint16 *buf, float CYCLES_PER_DRAW) // *FP*
NES_PPU::do_scanline_and_draw_bankswitch_per_tile (uint16 *buf, fixed16 CYCLES_PER_DRAW)
...
void
#if defined (DO_SCANLINE_BANKSWITCH_PER_TILE)
// NES_PPU::do_scanline_and_dont_draw_bankswitch_per_tile(float CYCLES_PER_DRAW) // *FP*
NES_PPU::do_scanline_and_dont_draw_bankswitch_per_tile(fixed16 CYCLES_PER_DRAW)
#elif defined (DO_SCANLINE_MMC5)
