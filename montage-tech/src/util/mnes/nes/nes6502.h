...
** nes6502.h,v 1.1.2.4 2002/11/05 09:59:02 tekezo Exp
*/
...
typedef uint8 (*nes6502_memread)(uint32 address);
typedef void (*nes6502_memwrite)(uint32 address, uint8 value);
...
/* Context get/set */
extern void nes6502_set_zeropage();
extern nes6502_context *nes6502_get_current_context();
extern void nes6502_setcontext();
...
/*
** nes6502.h,v
** Revision 1.1.2.4  2002/11/05 09:59:02  tekezo
** *** empty log message ***
**
** Revision 1.6  2001/10/08 17:39:33  tekezo
** fds pre-support
**
** Revision 1.5  2001/10/03 10:09:37  tekezo
** support save snapshot
**
** Revision 1.4  2001/09/23 17:28:48  tekezo
** bug fix for gradius2
**
** Revision 1.3  2001/09/23 10:53:54  tekezo
** now support SNSS
**
