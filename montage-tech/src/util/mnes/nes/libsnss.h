...
/*
      ...
      libsnss.h,v 1.3 2001/12/23 15:15:59 tekezo Exp
*/
/**************************************************************************/
...
#define VRAM_BLOCK_LENGTH 0x8000
...
typedef struct _SnssMapperBlock
{
   ...
   union _extraData
   {
      ...
      struct mapper248Data mapper248;
...
SNSS_RETURN_CODE SNSS_OpenFile (SNSS_FILE **snssFile, const uint16 *filename, 
                                SNSS_OPEN_MODE mode);
...
/*
** libsnss.h,v
** Revision 1.3  2001/12/23 15:15:59  tekezo
** *** empty log message ***
**
...
** *** empty log message ***
**
** Revision 1.12  2001/12/02 13:47:53  tekezo
** *** empty log message ***
**
** Revision 1.11  2001/11/07 16:30:09  tekezo
** 4.0-beta
**
** Revision 1.10  2001/09/23 17:28:48  tekezo
** bug fix for gradius2
**
** Revision 1.9  2001/09/23 10:53:54  tekezo
** now support SNSS
**
** Revision 1.8  2001/09/20 10:44:02  tekezo
** *** empty log message ***
**
