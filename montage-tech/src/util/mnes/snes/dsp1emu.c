...
#ifdef __OPT__
        unsigned int i;
//	CosTable2 = (double *) NES_MALLOC(INCR*sizeof(double));
//	SinTable2 = (double *) NES_MALLOC(INCR*sizeof(double));
	for (i=0; i<INCR; i++){
...
void DSPOp14()
{
   Op14Temp=Angle(Op14Zr)+(1/Cos(Angle(Op14Xr)))*(Angle(Op14U)*Cos(Angle(Op14Yr))-Angle(Op14F)*Sin(Angle(Op14Yr)));
   Op14Zrr=(short)(Op14Temp*65536.0/6.2832);
   Op14Temp=Angle(Op14Xr)+(Angle(Op14U)*Sin(Angle(Op14Yr))+Angle(Op14F)*Cos(Angle(Op14Yr)));
   Op14Xrr=(short)(Op14Temp*65536.0/6.2832);
   Op14Temp=Angle(Op14Yr)-tan(Angle(Op14Xr))*(Angle(Op14U)*Cos(Angle(Op14Yr))+Angle(Op14F)*Sin(Angle(Op14Yr)))+Angle(Op14L);
