...
void mt_fe_tn_sleep_tc2800_tc(MT_FE_DD_Device_Handle  handle)
{
	mt_fe_tn_sleep_tc2800(&tc2800_tuner_cfg);
}

void mt_fe_tn_wakeup_tc2800_tc(MT_FE_DD_Device_Handle  handle)
{
	mt_fe_tn_wakeup_tc2800(&tc2800_tuner_cfg);
}
