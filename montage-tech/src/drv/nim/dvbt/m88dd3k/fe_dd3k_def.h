...
*	Modify			2.80.10_beta		2015.07.13 		WangBingju
*******************************************************************************************************************/
...
#define MT_FE_DRIVER_VERSION					0x28000
...
typedef struct _MT_FE_DD_TN_DEV_SETTINGS
{
	...
	S32 (*tuner_sleep)(void *handle);							/* tuner sleep function */
	S32 (*tuner_wake_up)(void *handle);							/* tuner wake up function */
