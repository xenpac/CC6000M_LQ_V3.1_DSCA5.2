 ...
 * Modify           0.01.14     2015.03.18      Lei.Zhu
 * Modify           0.01.16     2015.04.02      Lei.Zhu
 * Modify           0.01.21     2015.04.24      Lei.Zhu
 * Modify           0.01.22     2015.05.27      Lei.Zhu
 * Modify           0.01.24     2015.07.10      Lei.Zhu
 *----------------------------------------------------------------------------
 *****************************************************************************/
...
MT_FE_DD_Device_Handle  DD_3800_handle=NULL;
MT_FE_TN_DEVICE_SETTINGS_TC3800 TC3800_tuner_cfg;


S32 _mt_fe_tn_get_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 *reg_data)
{
	DD_3800_handle->tn_read(DD_3800_handle,&reg_addr,1,reg_data,1);
	return 0;
}
S32 _mt_fe_tn_set_reg_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U8 reg_addr, U8 reg_data)
{
	...
	DD_3800_handle->tn_write(DD_3800_handle,data,2);
	return 0;
}
...
void _mt_sleep_tc3800(U32 ticks_ms)
{
	DD_3800_handle->mt_sleep(ticks_ms);
}
...
void _mt_fe_tn_set_RF_front_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	if((handle->tuner_application == 1) || (handle->tuner_application == 3) || (handle->tuner_application == 4))
	{
		...
		{
			_mt_fe_tn_set_reg_tc3800(handle, 0x1f, 0xc1);
		}
	...
	{
					_mt_fe_tn_set_reg_tc3800(handle, 0x1f, 0xc9);
				}
			}
			else
			{
		...
		_mt_fe_tn_set_reg_tc3800(handle, 0x1f, 0xe5);
				...
				{
					_mt_fe_tn_set_reg_tc3800(handle, 0x1f, 0xc5);
				}
			}
		}
		else
...
void _mt_fe_tn_set_PLL_freq_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	_mt_fe_tn_set_reg_tc3800(handle, 0x38, 0x80);
	_mt_fe_tn_set_reg_tc3800(handle, 0x39, 0x40);
	...
	if(((freq_KHz >= 51000) && (freq_KHz <= 53000)) ||
	   (freq_KHz == 78000) || (freq_KHz == 79000) ||
		    ...
		    ((freq_KHz > 737000) && (freq_KHz < 738000)))
	{
		CDIV = CDIV - 2;
	}
...
void _mt_fe_tn_set_DAC_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	if (handle->tuner_application == 4)
	{
		if (handle->tuner_bandwidth == 7)
		{
			f2d = handle->tuner_bandwidth * 1000 / 2 - 100;
		}
		else
		{
...
void _mt_fe_tn_preset_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	if(handle->tuner_int_fast_set == 1)
	{
		...
		if((handle->tuner_moni_type == 3) || (handle->tuner_application == 3) || (handle->tuner_application == 4))
		{
...
void _mt_fe_tn_lpf_cal_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	if(((handle->tuner_application == 3) || (handle->tuner_application == 4)) && (handle->tuner_freq >= 780000) && (handle->tuner_freq <= 790000))
	{
		if(temp_code >= 12)
		{
			...
			{
				_mt_fe_tn_set_reg_tc3800(handle, 0x1f, 0xd1);
			}
			buf4_rf = 4;
		}
		else if(temp_code >= 10)
...
{
	U8	buf = 0;
	_mt_fe_tn_get_reg_tc3800(handle, 0x5d, &buf);
	...
	else
	{
		_mt_fe_tn_set_reg_tc3800(handle, 0xbf, 0x01);
	  	 if (handle->tuner_gpio_out == 1) 
		{
	    		_mt_fe_tn_set_reg_tc3800(handle, 0x5d, buf);
		}
	}
...
void mt_fe_tn_init_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	...
	{
		handle->tuner_dev_addr			 = TUNER_I2C_ADDR_TC3800;
	...
	//	handle->tuner_application		 = 0;
		...
		handle->tuner_version			 = 124;  
		handle->tuner_time				 = 15071014;
...
void mt_fe_tn_set_freq_tc3800(MT_FE_Tuner_Handle_TC3800 handle, U32 freq_KHz)
{
	...
	U8 buf = 0, buf1 = 0, buf2 = 0, buf3 = 0, buf4 = 0, buf5 = 0, buf6 = 0, buf7 = 0;
	...
	while(buf7 > 0)
	{
            _mt_fe_tn_get_reg_tc3800(handle, 0x06, &buf5);
	    buf5 = (U8)(buf5 & 0x10);
    	    _mt_fe_tn_get_reg_tc3800(handle, 0x56, &buf6);
	    buf6 = (U8)(buf6 & 0x02);
		...
		break;
	     ...
	     {
		_mt_fe_tn_set_reg_tc3800(handle, 0x39, 0xc2);
		_mt_fe_tn_set_reg_tc3800(handle, 0x38, 0x80);
		_mt_fe_tn_set_reg_tc3800(handle, 0x38, 0xc0);
	...
	_mt_sleep_tc3800(tWait2);

	if(handle->tuner_int_fast_set == 1)
	{
		if((handle->tuner_application == 3) || (handle->tuner_application == 4))
		{
			_mt_fe_tn_set_reg_bit_tc3800(handle, 0x97, 0x05, 2, 0);
		}
		else
		{
		...
		if((handle->tuner_moni_type == 3) || (handle->tuner_application == 1) || (handle->tuner_application == 3) || (handle->tuner_application == 4))
		{
			_mt_fe_tn_set_reg_tc3800(handle, 0xb5, 0x75);
			_mt_fe_tn_set_reg_tc3800(handle, 0xbb, 0xe8);
		}
...
/*****************************************************************************/
/*API: 	mt_fe_tn_set_GPIOout_high_tc3800									 */
/*****************************************************************************/
void mt_fe_tn_set_GPIOout_high_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	_mt_fe_tn_set_reg_bit_tc3800(handle, 0x5d, 0x07, 6, 4);
	return;
}

/*****************************************************************************/
/*API: 	mt_fe_tn_set_GPIOout_lowt_tc3800									 */
/*****************************************************************************/
void mt_fe_tn_set_GPIOout_low_tc3800(MT_FE_Tuner_Handle_TC3800 handle)
{
	_mt_fe_tn_set_reg_bit_tc3800(handle, 0x5d, 0x03, 6, 4);
	return;
}
...
{
	DD_3800_handle = handle;
	
	if(DD_3800_handle->demod_cur_mode!=MtFeType_CTTB)
	{
		TC3800_tuner_cfg.tuner_init_OK = DD_3800_handle->tuner_dc_settings.tuner_init_ok;
		TC3800_tuner_cfg.tuner_application = 0;
	}
	else
	{
		TC3800_tuner_cfg.tuner_init_OK = DD_3800_handle->tuner_ct_settings.tuner_init_ok;
		TC3800_tuner_cfg.tuner_application = 1;
	}
	
	mt_fe_tn_init_tc3800(&TC3800_tuner_cfg);
	
	if(DD_3800_handle->demod_cur_mode!=MtFeType_CTTB)
	{
		DD_3800_handle->tuner_dc_settings.tuner_init_ok = TC3800_tuner_cfg.tuner_init_OK;
	}
	else
	{
		DD_3800_handle->tuner_ct_settings.tuner_init_ok = TC3800_tuner_cfg.tuner_init_OK;
	}
	return MtFeErr_Ok;
}
...
MT_FE_RET mt_fe_tn_set_freq_tc3800_tc(MT_FE_DD_Device_Handle  handle,U32 Freq_Hz)
{
	...
	mt_fe_tn_set_freq_tc3800(&TC3800_tuner_cfg, Freq_KHz);
	
	if(DD_3800_handle->demod_id == MtFeDmdId_DD630X)
		_mt_fe_tn_set_reg_tc3800(&TC3800_tuner_cfg, 0x1e, 0x9d);
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_get_strength_tc3800_tc(MT_FE_DD_Device_Handle  handle,S8 *p_strength)
{
	S32 strength = 0;
	strength = mt_fe_tn_get_signal_strength_tc3800(&TC3800_tuner_cfg) + 107;
	if(strength >= 100)
		strength = 100;
	*p_strength = (U8)strength;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_sleep_tc3800_tc(MT_FE_DD_Device_Handle  handle)
{
	mt_fe_tn_sleep_tc3800(&TC3800_tuner_cfg);
	return MtFeErr_Ok;
}
...
MT_FE_RET mt_fe_tn_wake_up_tc3800_tc(MT_FE_DD_Device_Handle  handle)
{
	...
	mt_fe_tn_init_tc3800_tc(handle);

	return MtFeErr_Ok;
}

MT_FE_RET mt_fe_tn_application_tc3800(U8 tc3800_application)
{
	TC3800_tuner_cfg.tuner_application = tc3800_application;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_loop_tc3800(S16 tc3800_1oop)
{
	TC3800_tuner_cfg.tuner_mode = tc3800_1oop;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_loop_add_tc3800(U8 tc3800_1oop_add)
{
	TC3800_tuner_cfg.tuner_int_lt = tc3800_1oop_add;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_crystal_tc3800(U32 tc3800_crystal)
{
	TC3800_tuner_cfg.tuner_crystal = tc3800_crystal;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_im_tc3800(U8 tc3800_im)
{
	TC3800_tuner_cfg.tuner_int_im= tc3800_im;
	return MtFeErr_Ok;
}
MT_FE_RET mt_fe_tn_clock_tc3800(U8 tc3800_clock)
{
	TC3800_tuner_cfg.tuner_clock_out = tc3800_clock;
	return MtFeErr_Ok;
}
