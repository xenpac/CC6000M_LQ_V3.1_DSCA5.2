...
//	Get PLP information
//--------------------------------------
DMD_ERROR_t DMD_API DMD_get_dataPLPs(  DMD_u8_t * pPLPIds, DMD_u8_t * pNumPLPs , DMD_PARAMETER_t* param  );
DMD_ERROR_t DMD_API DMD_get_single_PLP_type(DMD_PARAMETER_t* param, DMD_u8_t plp_layer_number); //20131211, to optimize scan time
