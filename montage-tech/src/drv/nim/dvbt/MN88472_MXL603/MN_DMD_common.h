...
#endif
/* **************************************************** */
/* Welcome ! Pls. add I2C api to control tuner and DMD*/
/* **************************************************** */
//#define PC_CONTROL_FE //it's for PC to communicate with FE. 
/*
Close define : use I2C functions in < MN_I2C.c >> Customer use their BE's 
open define  : use I2C functions in < MN_I2C_fx2i2c.c>> link function in lib\fx2i2c.dll
*/

/* **************************************************** */
/* OPEN ALL debug to do debugging */
/* **************************************************** */
//#define COMMON_DEBUG_ON  
#ifdef COMMON_DEBUG_ON
#define DMD_DEBUG //mtos_printk
#endif

/* **************************************************** */
/* Demod type setting *//* < User define 1 > */
/* **************************************************** */
#ifdef USE_DEMOD_MN88472
#define DEMOD_TYPE DMD_TYPE_MN88472
#else
#define DEMOD_TYPE DMD_TYPE_MN88473
#endif
// 1-1 SoC communicate with Tuner directly or by Demod 
...
// 1-2 Tuner I2C control method by Demod 
 ...
 #define DEMOD_CONTROL_TUNER_I2C_MODE TCB_I2C_FORMAT_REPEAT_MODE
  #if (DEMOD_TYPE == DMD_TYPE_MN88473)
     #undef DEMOD_CONTROL_TUNER_I2C_MODE
    #define DEMOD_CONTROL_TUNER_I2C_MODE TCB_I2C_FORMAT_REPEAT_MODE//TCB_I2C_FORMAT_REPEAT_MODE //TCB_I2C_FORMAT_BYPASS_MODE
  #endif
#endif
...
//#define XTAL_FREQ DMD_XTAL20500KHZ_IF5MHZ
#define XTAL_FREQ DMD_XTAL24000KHZ_IF5MHZ
/* **************************************************** */
/* DMD Defines */
/* **************************************************** */
...
/* for Debug */
/* **************************************************** */
#if 0 //def DMD_DEBUG // this is for PC control tool 
#define DMD_DBG_TRACE	mtos_printk //{fDMD_DEBUG( stderr , str ); fDMD_DEBUG( stderr , "\n" ) ; }
#else 
#define DMD_DBG_TRACE(...)  do{} while(0)//mtos_printk
#endif
