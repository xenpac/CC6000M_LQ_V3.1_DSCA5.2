...
#ifndef TUNER_TYPE
#error "Good day today~~[ATTENTION] If you are using Tuner Mxl603, pls. DO OPEN define 'TUNER_TYPE MXL603' , it's quite necessary for better performance!!"
#endif
/* **************************************************** */
/*!
...
//DMD_u32_t DMD_RegSet_Rev = 130801; // MN88472 DD version.
DMD_u32_t DMD_RegSet_Rev = 131220; //MN88472 + MN88473 together
...
#if (defined(TUNER_TYPE) == MXL603)||(defined(TUNER_TYPE) == NXP18250B)
	{ 0x18 , 0xB0 , 0x9 , DMD_E_ARRAY }, //IF 1.0Vpp
#else
	{ 0x18 , 0xB0 , 0xA , DMD_E_ARRAY }, //IF 1.5Vpp
#endif
...
/*!
   ...
   */
/* **************************************************** */
#define DD_UPDATE_v20140130_JP 1
//20131220, added CONFIG for MN88473
#if (XTAL_FREQ == DMD_XTAL20480KHZ_IF5MHZ)||(XTAL_FREQ == DMD_XTAL20500KHZ_IF5MHZ) //MN88473 didn't use 20.5Mhz XTAL, just for compiling
