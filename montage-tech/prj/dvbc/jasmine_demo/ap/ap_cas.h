...
typedef enum
{
  ...
  */
  ...
  /*!
  get system time info from CA
  */
  CAS_CMD_SYSTEM_TIME_GET,
  /*!
  cas cmd sync end
  */
...
typedef enum
{
  ...
  CAS_EVT_STB_NOTIFICATION,
   ...
   urgent msg
   */
  CAS_EVT_SHOW_URGENT_MSG,
    /*!
   hide urgent msg
   */  
  CAS_EVT_HIDE_URGENT_MSG,
    /*!
