...
extern u32 mul_ota_dm_api_dm_read(u8 block_id,u16 offset,
...
void ap_uio_init_kep_map(void)
{
  ...
  read_len = dm_read(class_get_handle_by_id(DM_CLASS_ID),
                              ...
                              (u8 *)cfg_tmp);
#else
  read_len = mul_ota_dm_api_dm_read(IRKEY_BLOCK_ID,
                             0,
                            128,
                            (u8 *)cfg_tmp);
 #endif
  ...
  read_len = dm_read(class_get_handle_by_id(DM_CLASS_ID),
                              ...
                              (u8 *)cfg_tmp);
#else
  read_len = mul_ota_dm_api_dm_read(IRKEY1_BLOCK_ID,
                             0,
                            128,
                            (u8 *)cfg_tmp);
 #endif
  ...
  read_len = dm_read(class_get_handle_by_id(DM_CLASS_ID),
                              ...
                              (u8 *)cfg_tmp);
#else
  read_len = mul_ota_dm_api_dm_read(IRKEY2_BLOCK_ID,
                             0,
                            128,
                            (u8 *)cfg_tmp);
 #endif
  ...
  read_len = dm_read(class_get_handle_by_id(DM_CLASS_ID),
                              ...
                              (u8 *)cfg_tmp);
#else
  read_len = mul_ota_dm_api_dm_read(FPKEY_BLOCK_ID,
                             0,
                            128,
                            (u8 *)cfg_tmp);
 #endif
...
BOOL ap_uio_translate_key(v_key_t *key)
{
  ...
  //OS_PRINTF("ap_uio_translate_key key->usr:%d, key->v_key:0x%x\n",key->usr, key->v_key);
