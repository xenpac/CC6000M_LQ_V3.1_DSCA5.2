...
{/*003|--+ SID_YOUTUBE_ACTIVE */
    ...
    {SID_YOUTUBE_INACTIVE, MSG_SAVE, NULL, (SFUNA) StaYoutube_on_active_exit},
...
{/*007|        |--+ SID_YOUTUBE_MP_VDOLIST_NORMAL */
    ...
    {SID_INTERNAL, MSG_PAGE_UP, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_most_popu_on_change_page},
    {SID_INTERNAL, MSG_PAGE_DOWN, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_most_popu_on_change_page},
    ...
    {SID_INTERNAL, MSG_PIC_EVT_DATA_ERROR, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
...
{/*014|        |--+ SID_YOUTUBE_CATE_LIST_NORMAL */
    {SID_INTERNAL, MSG_FOCUS_UP, (SFUNC) StcYoutube_is_on_catelist, (SFUNA) StaYoutube_category_on_catelist_updown},
    {SID_INTERNAL, MSG_FOCUS_DOWN, (SFUNC) StcYoutube_is_on_catelist, (SFUNA) StaYoutube_category_on_catelist_updown},
    {SID_INTERNAL, MSG_PAGE_UP, (SFUNC) StcYoutube_is_on_catelist, (SFUNA) StaYoutube_category_on_catelist_updown},
    {SID_INTERNAL, MSG_PAGE_DOWN, (SFUNC) StcYoutube_is_on_catelist, (SFUNA) StaYoutube_category_on_catelist_updown},
...
{/*017|        |--+ SID_YOUTUBE_CATE_VDOLIST_NORMAL */
    ...
    {SID_INTERNAL, MSG_PAGE_UP, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_category_on_vdolist_change_page},
    {SID_INTERNAL, MSG_PAGE_DOWN, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_category_on_vdolist_change_page},
    {SID_INTERNAL, MSG_PIC_EVT_DRAW_END, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_end},
    {SID_INTERNAL, MSG_PIC_EVT_TOO_LARGE, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
    {SID_INTERNAL, MSG_PIC_EVT_UNSUPPORT, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
    {SID_INTERNAL, MSG_PIC_EVT_DATA_ERROR, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
...
{/*025|        |--+ SID_YOUTUBE_SEARCH_VDOLIST_NORMAL */
    ...
    {SID_INTERNAL, MSG_PAGE_UP, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_search_on_vdolist_change_page},
    {SID_INTERNAL, MSG_PAGE_DOWN, (SFUNC) StcYoutube_is_on_vdolist, (SFUNA) StaYoutube_search_on_vdolist_change_page},
    {SID_INTERNAL, MSG_PIC_EVT_DRAW_END, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_end},
    {SID_INTERNAL, MSG_PIC_EVT_TOO_LARGE, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
    {SID_INTERNAL, MSG_PIC_EVT_UNSUPPORT, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
    {SID_INTERNAL, MSG_PIC_EVT_DATA_ERROR, NULL, (SFUNA) StaYoutube_most_popu_pic_draw_fail},
...
{/*030|     |--+ SID_YOUTUBE_COUNTRY_OPTLIST */
    {SID_INTERNAL, MSG_FOCUS_UP, (SFUNC) StcYoutube_is_on_optlist, (SFUNA) StaYoutube_country_on_vdolist_updown},
    {SID_INTERNAL, MSG_FOCUS_DOWN, (SFUNC) StcYoutube_is_on_optlist, (SFUNA) StaYoutube_country_on_vdolist_updown},
    {SID_INTERNAL, MSG_PAGE_UP, (SFUNC) StcYoutube_is_on_optlist, (SFUNA) StaYoutube_country_on_vdolist_updown},
    {SID_INTERNAL, MSG_PAGE_DOWN, (SFUNC) StcYoutube_is_on_optlist, (SFUNA) StaYoutube_country_on_vdolist_updown},
