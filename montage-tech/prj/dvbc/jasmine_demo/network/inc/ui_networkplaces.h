...
#define NETWORK_LIST_MID_H    ((COMM_ITEM_H + NETWORK_LIST_ITEM_VGAP) * NETWORK_LIST_PAGE - NETWORK_LIST_ITEM_VGAP)

#define NETWORK_LIST_ITEM_H        COMM_ITEM_H
#define NETWORK_LIST_ITEM_VGAP    10// 4
