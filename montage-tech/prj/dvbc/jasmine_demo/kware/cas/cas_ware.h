...
the cas max entitle len
  */
#ifdef   ENABLE_CONAXK
#define CAS_MAX_PRODUCT_ENTITLE_NUM (150)
#else
...
/*!
  the max num of the vendorID
  */
#define CAS_MAX_VENDOR_ID 10
/*!
  The type of cas Lib
  */
typedef enum
...
typedef enum
{
  ...
  POLICY_BY_SAVE_TIME,
  /*!
    current prog level info
    */
  CAS_S_PROG_LEVEL_INFO,
...
/*!
  ...
  CAS_E_PPC_PROG,  
/*!
    ppv prog entitle success
    */
  CAS_E_PPV_PROG_ENTITLE_SUCCESS,    
/*!
    ppv prog entitle failure
    */
  CAS_E_PPV_PROG_ENTITLE_FAILURE,    
/*!
    ppc prog entitle success
    */
  CAS_E_PPC_PROG_ENTITLE_SUCCESS,    
/*!
    ppc prog entitle failure
    */
  CAS_E_PPC_PROG_ENTITLE_FAILURE,     
/*!
    remain day
    */
  CAS_E_REMAIN_DAY,       
...
/*!
  ...
  card init install
*/
  CAS_E_CARD_INIT_INSTALL,
     /*!
  card installing
*/
  CAS_E_CARD_INSTALLING,
     /*!
  card repair
*/
  CAS_E_CARD_REPAIR,
...
/*!
  ...
  CAS_S_CLEAR_ANNOUNCE_DISPLAY,  
    /*!
    clear cur announce display
    */
  CAS_S_GET_KEY,
/*!
...
/*!
  ...
  mother card invalid
*/
  CAS_S_MOTHER_CARD_INVALID,
     /*!
  son card invalid
*/
  CAS_S_SON_CARD_INVALID,
     /*!
  card not paired
*/
  CAS_S_MOTHER_SON_CARD_NOT_PAIR,
     /*!
  mother card communication fail
*/
  CAS_S_MOTHER_CARD_COMM_FAIL,
     /*!
  son card communication fail
*/
  CAS_S_SON_CARD_COMM_FAIL,
     /*!
  card not in active time
*/
  CAS_S_CARD_NOT_IN_ACTTIME,
     /*!
  insert next card
*/
  CAS_S_CARD_INSERT_NEXT_CARD,
     /*!
  stop active
*/
  CAS_S_CARD_STOP_ACTIVE,
/*!
    email Space Exhaust
    */
...
/*!
  dmt OSD card out
  */
  CAS_C_SHOW_OSD_CARD_OUT,
/*!
  dmt OSD contact operator
  */
  CAS_C_SHOW_OSD_CONTACT_OPERATOR,
/*!
  dmt show urgent msg
  */
  CAS_C_SHOW_URGENT_MSG,
/*!
  dmt hide urgent msg
  */
  CAS_C_HIDE_URGENT_MSG,  
/*!
...
/*!
  ...
  */
  CAS_E_CARD_MATCH_OK,
  /*!
      stb and card  no match
  */
  CAS_E_CARD_NO_MATCH,
  /*!
      stb and card  cancel match
  */
  CAS_E_CARD_CANCEL_MATCH,  
  /*!
      stb and card  cancel match failure
  */
  CAS_E_CARD_CANCEL_MATCH_FAILURE,    
  /*!
      stb and card match error
  */
  CAS_E_CARD_MATCH_ERROR,
    /*!
      card is not enable
  */
  CAS_E_CARD_NOT_ENABLE,
    /*!
      card credit is full
  */
  CAS_E_CARD_CREDIT_FULL,  
    /*!
      card is unrecognised
  */
  CAS_E_CARD_UNRECOGNISED,  
    /*!
      card version error
  */
  CAS_E_CARD_VERSION_ERROR,    
    /*!
      ippv event zero
  */
  CAS_E_IPPV_EVENT_ZERO,      
  /*!
      prog no right
  */
  CAS_E_PROG_NO_RIGHT,
...
/*!
   ...
   */
  u32  special_id;
}cas_mail_header_t,cas_announce_header_t;
...
typedef struct
{
  ...
  /*!
    cas version.
    */
  u8 softver[CAS_CARD_VER_MAX_LEN + 1];
   /*!
    card number
    */
  u32 ca_card_number;
...
/*!
  ...
  u8 smcProvider[MAX_SMCPROVIDER_NAME_LEN + 1];
    ...
    kingvon card info
    */
  u8 vendorID[CAS_MAX_VENDOR_ID + 1];
}cas_card_info_t;
...
/*!
  ...
  */
	u16  SubscriptionRef;
/*!
  octet_str CurEntitlement
  */
	u8   CurEntitlement[4];
/*!
  octet_str PreEntitlement
  */
	u8   PreEntitlement[4];
/*!
      the start when this mail send, format: BCD code, 0xYYYYMMDDHHMMSS
      TRCAS: start time of one product
      */
  u8  start_time_pre[CAS_MAIL_DATE_MAX_LEN];
/*!
      the expired when this mail send, format: BCD code, 0xYYYYMMDDHHMMSS
      TRCAS: end time of one product
      */
  u8  expired_time_pre[CAS_MAIL_DATE_MAX_LEN];
#endif
...
/*!
  time between two feed times
  */
  u8   bdPeriod;    /*绑定周期, 0:无绑定周期;其他:单位为"小时".*/
/*!
  parent card sn
  */
...
/*!
  ...
  /*!
    Get mail max
    */
  CAS_IOCMD_GET_ANNOUNCE_MAX,
/*!
    Get mail overlay policy
    */
  CAS_IOCMD_GET_ANNOUNCE_POLICY,
/*!
    Get serial data
    */
...
/*!
  ...
  /*!
    Get current mail
    */
  CAS_IOCMD_GET_CURRENT_ANNOUNCE,  
 /*!
...
/*!
 ...
 /*!
  ...
  /*!
      dmt urgent msg get
      */
  CAS_IOCMD_URGENT_MSG_GET,
  CAS_IOCMD_PROG_LEVEL_INFO,
  CAS_IOCMD_UPDATE_PRODUCT_LIST,
  CAS_IOCMD_SERVICE_HIDE_CHECK,
}cas_ioctrl_cmd_t;
/*!
...
typedef struct
{
  u16 s_id;
  u32 autor_pocket_no;
  u16 subscription_ref;
  u8 entitlement_bit_pointer;
}cas_autor_pocket_info_t;
...
/*!
      event tag
      */
  u8  eventtag[CAS_PRODUCT_NAME_MAX_LEN];
/*!
      product name
      */
  u8  product_name[CAS_PRODUCT_NAME_MAX_LEN];
/*!
      the event start time, format: BCD code, 0xYYYYMMDDHHMMSS
      TRCAS: start time of one product
      */
  u8  start_time[CAS_MAIL_DATE_MAX_LEN];
/*!
      the event expired time, format: BCD code, 0xYYYYMMDDHHMMSS
      TRCAS: end time of one product
      */
  u8  expired_time[CAS_MAIL_DATE_MAX_LEN];
/*!
      auth type, AuthType=0x00  minutes_left; AuthType=0x02  credits _left
      */
  u8  auth_type;
/*!
      minutes or credits left
      */
  u16  minOrcreditsleft;
}conax_event_info_t;
...
/*!
  Attach the CAS module: Enigma
  \param[in] p_cfg The configuation of this CAS
  \param[out] p_cam_id The attached CAS handle

  \return Return 0 for success and others for failure.
  */
extern RET_CODE cas_enigma_attach(cas_module_cfg_t *p_cfg, u32 *p_cam_id);



/*!
  Attach the CAS module: dmt
  \param[in] p_cfg The configuation of this CAS
  \param[out] p_cam_id The attached CAS handle

  \return Return 0 for success and others for failure.
  */
extern RET_CODE cas_dmt_attach(cas_module_cfg_t *p_cfg, u32 *p_cam_id);
