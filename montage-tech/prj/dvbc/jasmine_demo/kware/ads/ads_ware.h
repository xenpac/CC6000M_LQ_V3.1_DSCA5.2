...
/*!
    ad write rectangle
    */
  ADS_O_WRITE_RECTANGLE,
/*!
    ad red rectangle
    */
  ADS_O_READ_RECTANGLE,
/*!
    end,
    */
  ADS_EVT_ALL,
...
/*!    
  ...
  */ 
  ...
  /*!    
  Get ADS data(for szxc ADS)
  */ 
  ADS_IOCMD_GET_GROUP,
  ADS_IOCMD_GET_INFO,
  ADS_IOCMD_GET_DATA,
  /*!
  osd rolling finish notify message(for szxc ADS)
  */
  ADS_IOCMD_AD_NOFITY,
}ads_ioctrl_cmd_t;
...
/////////////////////////////////////////////////////////////////////////////
// CHangZhouTsStream dialog
typedef struct tagTs_Stream_FileHead
{
...
/*!
  The ADS adapter configuation parameters
  */
typedef struct
{
/*!
...
/*!    
    ...
    */
    RET_CODE (*display_ad)(ads_info_t *p_ads_info);
/*!    
    The callback of hide current display ad
    */
    RET_CODE (*hide_ad)(ads_info_t *p_ads_info);
}ads_adapter_cfg_t;
...
/*!    
    The callback of display_logo
    */
  void (*display_logo)(u32 length, u8 *p_data);
...
/*!    
 ...
 RET_CODE (*get_current_service)(ads_service_t *service);
 
 BOOL (*show_adv_permission)(ads_ad_type_t ad_type);
...
/*!
  Attach the boyuan module: boyuan
  \param[out] p_cam_id The attached ADS handle
  \return Return 0 for success and others for failure.
  */
extern RET_CODE ads_adt_by_attach(ads_module_cfg_t * p_cfg, u32 *p_adm_id);
RET_CODE ads_attach(u32 adm_id);
...
/*!
  ...
  \return Return 0 for success and others for failure.
  */
extern RET_CODE ads_init(u32 adm_id, ads_adapter_cfg_t *p_cfg);
...
extern RET_CODE ads_module_init(ads_module_id_t cam_id);

/*!
  Display a specific AD
  \param[in] adm_id ADS module id
  \param[in] p_cfg The info of ads to show
  \return Return 0 for success and others for failure.
  */
extern RET_CODE ads_display(u32 adm_id, ads_info_t *p_cfg);
...
/*!
  ...
  \return Return 0 for success and others for failure.
  */
extern RET_CODE ads_hide(u32 adm_id, ads_info_t *p_cfg);
