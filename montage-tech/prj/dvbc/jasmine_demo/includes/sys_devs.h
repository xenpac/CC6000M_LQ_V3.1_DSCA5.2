...
#define CHARSTO_ATTACH  spi_warriors_attach
#define CHARSTO_NAME "SPI_WARRIORS_0"

/* i2c */
extern RET_CODE i2c_wactrller_attach(char *name);
#define I2CM_ATTAGH i2c_wactrller_attach
//#endif
#define I2CM_NAME   "I2CM_WARRIORS_0"
...
/* audio */
extern RET_CODE warriors_audio_attach(char * name);
#define AUDIO_ATTACH warriors_audio_attach
#define AUDIO_NAME "AUDIO_WARRIORS_0"
