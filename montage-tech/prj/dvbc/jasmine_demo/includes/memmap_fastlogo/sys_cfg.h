...
#if defined DESAI_56_CA || defined DESAI_52_CA || defined DESAI_40_CA || defined STARTUP_NIT_VERSION_CHECK
...
/*!
   Load different meomory config policy
  */
#ifdef MIN_AV_64M
#ifdef MIN_AV_SDONLY
#include "fastlogo_mem_64m_sd.h"
#else
#include "fastlogo_mem_64m.h"
#endif
#else
#include "fastlogo_mem_128m.h"
#endif
...
/*!
  ...
  */
#define AV_INIT_CODE_SIZE 0x0
//#define AV_INIT_CODE_SIZE 0x10000

/*!
  av cpu stack size 1M-20k
  */
#define AV_STACK_SIZE 0x20000
...
/*!
  ...
  */
#define VIDEO_FW_CFG_SIZE           0x132c000
