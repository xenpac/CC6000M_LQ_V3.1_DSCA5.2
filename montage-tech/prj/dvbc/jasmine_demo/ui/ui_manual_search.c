...
static comm_help_data_t2 manual_search_help_data[] = //help bar data
{
   {
    2, 100, {80, 600},
    {
  ...
  },
  {
    ...
    {
      HELP_RSC_BMP   | IM_CHANGE,
      HELP_RSC_STRID | IDS_INSTALLATION_HELP_MANUAL_INSTALL_NET,
    },
  },  
  {
    2, 100, {80, 600},
...
RET_CODE manual_search_num_edit_proc(control_t *p_ctrl, u16 msg, u32 para1, u32 para2);
RET_CODE manual_search_qam_proc(control_t *p_ctrl, u16 msg, u32 para1, u32 para2);

static u16 manual_search_pwdlg_keymap(u16 key);
RET_CODE manual_search_pwdlg_proc(control_t *ctrl, u16 msg, u32 para1, u32 para2);
...
static RET_CODE start_auto_scan(control_t *cont, u16 msg, u32 para1, u32 para2)
{
  ...
  p_ctrl = ctrl_get_child_by_id(cont, IDC_SPECIFY_TP_NIT);
...
{
  control_t *p_cont, *p_ctrl[MANUAL_SEARCH_ITEM_CNT], *p_specify_tp_frm, *p_searching_frm;
  control_t *p_bar;
  u8 i = 0;
  u16 y;
  
  u16 stxt[MANUAL_SEARCH_ITEM_CNT] =
  { IDS_FREQUENCY, IDS_SYMBOL, IDS_CONSTELLATION, IDS_NET_SEARCH};
  dvbc_lock_t tp = {0};
  memset(p_ctrl , 0, sizeof(control_t *) * MANUAL_SEARCH_ITEM_CNT);
  is_finished = FALSE;
  ...
  p_cont = ui_comm_root_create(ROOT_ID_MANUAL_SEARCH,
                               0,
                               COMM_BG_X,
                               COMM_BG_Y,
                               COMM_BG_W,
  ...
  p_specify_tp_frm = ctrl_create_ctrl(CTRL_CONT, (u8)IDC_SPECIFY_TP_FRM,
                            MANUAL_SEARCH_SPECIFY_TP_FRM_X, MANUAL_SEARCH_SPECIFY_TP_FRM_Y,
                            MANUAL_SEARCH_SPECIFY_TP_FRM_W, MANUAL_SEARCH_SPECIFY_TP_FRM_H,
                            p_cont, 0);
  ctrl_set_rstyle(p_specify_tp_frm, RSI_MANUAL_SEARCH_FRM, RSI_MANUAL_SEARCH_FRM, RSI_MANUAL_SEARCH_FRM);
  ...
  for(i = 0; i < MANUAL_SEARCH_ITEM_CNT; i++)
  {
    switch (i)
    {
      ...
      case 1:
        ...
        ui_comm_ctrl_set_proc(p_ctrl[i], manual_search_num_edit_proc);
      ...
      case 2:
        p_ctrl[i] = ui_comm_select_create(p_specify_tp_frm, (u8)(IDC_SPECIFY_TP_FREQ + i),
                                            ...
                                            MANUAL_SEARCH_ITEM_LW,
                                            MANUAL_SEARCH_ITEM_RW);
        ui_comm_ctrl_set_proc(p_ctrl[i], manual_search_qam_proc);
    ...
    ctrl_set_related_id(p_ctrl[i],
                        0, /* left */
                        (u8)((i - 1 + MANUAL_SEARCH_ITEM_CNT) % MANUAL_SEARCH_ITEM_CNT + 1), /* up */
                        0, /* right */
  ...
  p_searching_frm = ctrl_create_ctrl(CTRL_CONT, (u8)IDC_SIGNAL_INFO_FRM,
                            MANUAL_SEARCH_SIG_INFO_FRM_X, MANUAL_SEARCH_SIG_INFO_FRM_Y,
                            MANUAL_SEARCH_SIG_INFO_FRM_W, MANUAL_SEARCH_SIG_INFO_FRM_H,
                            p_cont, 0);
  ...
  p_bar = ui_comm_bar_create(p_searching_frm, IDC_SEARCH_SIG_STRENGTH_BAR,
                               MANUAL_SEARCH_SIG_STRENGTH_PBAR_X,
                               MANUAL_SEARCH_SIG_STRENGTH_PBAR_Y,
                               MANUAL_SEARCH_SIG_STRENGTH_PBAR_W,
                               MANUAL_SEARCH_SIG_STRENGTH_PBAR_H,
                               MANUAL_SEARCH_SIG_STRENGTH_NAME_X, 
                               MANUAL_SEARCH_SIG_STRENGTH_NAME_Y, 
                               MANUAL_SEARCH_SIG_STRENGTH_NAME_W, 
                               MANUAL_SEARCH_SIG_STRENGTH_NAME_H,
                               MANUAL_SEARCH_SIG_STRENGTH_PERCENT_X,
                               MANUAL_SEARCH_SIG_STRENGTH_PERCENT_Y,
                               MANUAL_SEARCH_SIG_STRENGTH_PERCENT_W,
                               MANUAL_SEARCH_SIG_STRENGTH_PERCENT_H);
  
  ui_comm_bar_set_param(p_bar, IDS_RFLEVEL, 0, 100, 100);

  ui_comm_bar_set_style(p_bar,
                        RSI_MANUAL_SEARCH_PBAR_BG, RSI_MANUAL_SEARCH_PBAR_MID,
  ...
  p_bar = ui_comm_bar_create(p_searching_frm, IDC_SEARCH_SIG_BER_BAR,
                               MANUAL_SEARCH_SIG_BER_PBAR_X,
                               MANUAL_SEARCH_SIG_BER_PBAR_Y,
                               MANUAL_SEARCH_SIG_BER_PBAR_W,
                               MANUAL_SEARCH_SIG_BER_PBAR_H,
                               MANUAL_SEARCH_SIG_BER_NAME_X, 
                               MANUAL_SEARCH_SIG_BER_NAME_Y, 
                               MANUAL_SEARCH_SIG_BER_NAME_W, 
                               MANUAL_SEARCH_SIG_BER_NAME_H,
                               MANUAL_SEARCH_SIG_BER_PERCENT_X,
                               MANUAL_SEARCH_SIG_BER_PERCENT_Y,
                               MANUAL_SEARCH_SIG_BER_PERCENT_W,
                               MANUAL_SEARCH_SIG_BER_PERCENT_H);
  ...
  p_bar = ui_comm_bar_create(p_searching_frm, IDC_SEARCH_SIG_SNR_BAR,
                               MANUAL_SEARCH_SIG_SNR_PBAR_X,
                               MANUAL_SEARCH_SIG_SNR_PBAR_Y,
                               MANUAL_SEARCH_SIG_SNR_PBAR_W,
                               MANUAL_SEARCH_SIG_SNR_PBAR_H,
                               MANUAL_SEARCH_SIG_SNR_NAME_X, 
                               MANUAL_SEARCH_SIG_SNR_NAME_Y, 
                               MANUAL_SEARCH_SIG_SNR_NAME_W, 
                               MANUAL_SEARCH_SIG_SNR_NAME_H,
                               MANUAL_SEARCH_SIG_SNR_PERCENT_X,
                               MANUAL_SEARCH_SIG_SNR_PERCENT_Y,
                               MANUAL_SEARCH_SIG_SNR_PERCENT_W,
                               MANUAL_SEARCH_SIG_SNR_PERCENT_H);
  ...
  ui_comm_help_create2(&manual_search_help_data[0], p_cont,FALSE);
  ctrl_default_proc(p_ctrl[0], MSG_GETFOCUS, 0, 0); /* focus on prog_name */
  ctrl_paint_ctrl(ctrl_get_root(p_cont), FALSE);
  
  ui_enable_signal_monitor(TRUE);
  manual_search_check_signal(p_specify_tp_frm, 0, 0, 0);

  return SUCCESS;
}


static RET_CODE on_manual_search_cont_focus_change_down(control_t *p_ctrl, u16 msg,
  u32 para1, u32 para2)
{
  ...
  if(ctrl_id == 5) 
  ui_comm_help_create2(&manual_search_help_data[0], p_parent,FALSE);
  else 
  ui_comm_help_create2(&manual_search_help_data[ctrl_id], p_parent,FALSE);
...
static RET_CODE on_manual_search_cont_focus_change_up(control_t *p_ctrl, u16 msg,
  u32 para1, u32 para2)
{
  control_t *p_child, *p_parent;
  u8 ctrl_id;
  ...
  if(ctrl_id == 1)
  ui_comm_help_create2(&manual_search_help_data[4], p_parent,FALSE);
  else
  ui_comm_help_create2(&manual_search_help_data[ctrl_id-2], p_parent,FALSE);
...
static RET_CODE on_manual_search_pwdlg_correct(control_t *p_ctrl, u16 msg, 
                                  u32 para1, u32 para2)
{
  ui_comm_pwdlg_close();

  return open_manual_search(0, 0);
}

static RET_CODE on_manual_search_pwdlg_exit(control_t *p_ctrl, u16 msg, 
                                  u32 para1, u32 para2)
{
  ui_comm_pwdlg_close();
...
RET_CODE preopen_manual_search(u32 para1, u32 para2)
{
  comm_pwdlg_data_t pwdlg_data =
  {
    ...
    manual_search_pwdlg_keymap,
    manual_search_pwdlg_proc,
    PWDLG_T_COMMON
  };
  BOOL is_lock;
...
static RET_CODE on_manual_search_change_freq_symbol(control_t *p_ctrl, u16 msg, u32 para1, u32 para2)
{
  ...
  manual_search_check_signal(p_ctrl->p_parent->p_parent, msg, para1, para2);
  return SUCCESS;
}
...
static RET_CODE on_manual_search_exit(control_t *p_ctrl, u16 msg, u32 para1, u32 para2)
{
...
BEGIN_MSGPROC(manual_search_cont_proc, ui_comm_root_proc)
  ON_COMMAND(MSG_EXIT, on_manual_search_exit)
  ON_COMMAND(MSG_EXIT_ALL, on_manual_search_exit)
...
BEGIN_MSGPROC(manual_search_tp_frm_proc, cont_class_proc)
  ...
  ON_COMMAND(MSG_FOCUS_UP,on_manual_search_cont_focus_change_up) 
  ON_COMMAND(MSG_FOCUS_DOWN,on_manual_search_cont_focus_change_down)  
END_MSGPROC(manual_search_tp_frm_proc, cont_class_proc)

BEGIN_MSGPROC(manual_search_num_edit_proc, ui_comm_num_proc)
  ON_COMMAND(MSG_NUMBER, on_manual_search_change_freq_symbol)
END_MSGPROC(manual_search_num_edit_proc, ui_comm_num_proc)

BEGIN_MSGPROC(manual_search_qam_proc, cbox_class_proc)
  ON_COMMAND(MSG_INCREASE, on_manual_search_change_qam)
  ON_COMMAND(MSG_DECREASE, on_manual_search_change_qam)
END_MSGPROC(manual_search_qam_proc, cbox_class_proc)

BEGIN_KEYMAP(manual_search_pwdlg_keymap, NULL)
  ...
  ON_EVENT(V_KEY_BACK, MSG_EXIT)
  ON_EVENT(V_KEY_MENU, MSG_EXIT)
END_KEYMAP(manual_search_pwdlg_keymap, NULL)

BEGIN_MSGPROC(manual_search_pwdlg_proc, cont_class_proc)
  ON_COMMAND(MSG_CORRECT_PWD, on_manual_search_pwdlg_correct)
  ON_COMMAND(MSG_EXIT, on_manual_search_pwdlg_exit)
END_MSGPROC(manual_search_pwdlg_proc, cont_class_proc)
