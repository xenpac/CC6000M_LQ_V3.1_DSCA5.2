...
/*!
  unicode buffer offset len,becode dvb_to_unicode size is differ 
  */
#define UNICODE_BUFFER_OFFSET_LEN (2)
...
typedef struct
{
  /*!
    ...
    */
  u8 item_desc[MAX_ITEM_DESC_LENGTH + 1];
  /*!
    Item char, such as cast name etc.
    */
  u8 item_char[MAX_ITEM_CHAR_LENGTH + 1];
}item_infor_t;
...
/*!
 ...
 /*!
 EPG database keep type when delete event
 */
typedef enum
{
/*!
  no keep
  */
  EPG_DB_KEEP_TYPE_NO = 0,
/*!
  keep net node
  */
  EPG_DB_KEEP_TYPE_NET,
/*!
  keep ts node
  */
  EPG_DB_KEEP_TYPE_TS,
/*!
  keep SVC node
  */
  EPG_DB_KEEP_TYPE_SVC,
}db_keep_type_t;
 
/*!
  eit edit id call back
  */
typedef BOOL (*eit_edit_id_call_back_t)(epg_eit_t *p_eit);
/*!
  eit edit info call back
  */
typedef BOOL (*eit_edit_info_call_back_t)(epg_eit_t *p_eit);
...
/*!
  epg database process eit edit call back
  */
