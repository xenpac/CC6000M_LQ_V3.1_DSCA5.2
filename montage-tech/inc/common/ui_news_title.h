...
#define NEWS_TTL_BMP_Y  30 
#define NEWS_TTL_BMP_W 110
#define NEWS_TTL_BMP_H 50

//item container
#define NEWS_ICONT_X  (NEWS_HGAP) //210
#define NEWS_ICONT_Y  75
#define NEWS_ICONT_W  (NEWS_CONT_W - 2 * NEWS_ICONT_X)//745
...
//item view
#define NEWS_ITEM_PREWX 0
#define NEWS_ITEM_PREWY 0
#define NEWS_ITEM_PREWW 150
...
#define NEWS_ITEM_TEXTW (NEWS_ITEM_W - NEWS_ITEM_TEXTX) //590
