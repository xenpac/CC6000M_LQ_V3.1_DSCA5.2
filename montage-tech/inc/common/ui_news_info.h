...
#define NEWS_INFO_MENU_H  SCREEN_HEIGHT

#define NEWS_INFO_PAGE_CONT_X  20
#define NEWS_INFO_PAGE_CONT_Y  150
#define NEWS_INFO_PAGE_CONT_W  300
#define NEWS_INFO_PAGE_CONT_H  30

#define NEWS_INFO_TITLE_X  10
#define NEWS_INFO_TITLE_Y  50
#define NEWS_INFO_TITLE_W  (NEWS_INFO_MENU_W - 20)
#define NEWS_INFO_TITLE_H  30

#define NEWS_INFO_MSG_X  10
#define NEWS_INFO_MSG_Y  150
...
#define NEWS_INFO_PREV_X  (NEWS_INFO_PAGE_CONT_X + 5)
#define NEWS_INFO_PREV_Y  (NEWS_INFO_PAGE_CONT_Y + 55)
#define NEWS_INFO_PREV_W   290
#define NEWS_INFO_PREV_H   220

#define NEWS_INFO_TEXT_X  (NEWS_INFO_PAGE_CONT_X * 2 + NEWS_INFO_PAGE_CONT_W)
...
#define NEWS_INFO_TEXT2_X  (NEWS_INFO_PAGE_CONT_X * 2)
#define NEWS_INFO_TEXT2_W  (NEWS_INFO_MENU_W - NEWS_INFO_TEXT_X - 34 + NEWS_INFO_PAGE_CONT_W)
