...
typedef struct
{
    u8  title[MAX_TITLE_LEN+1];  /*title of each item in one page*/
...
void ui_youtube_request_open(YT_FEED_TYPE type, YT_REGION_ID_T region);
void ui_youtube_request_close(void);
void ui_youtube_search(u8 *keyword, YT_REGION_ID_T region);
