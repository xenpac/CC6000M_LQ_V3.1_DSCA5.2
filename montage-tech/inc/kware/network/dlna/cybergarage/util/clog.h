...
extern unsigned long ul_stack_start_time;

#define DLNA_STACK_TRACE(format, ...)  \
    OS_PRINTF("[%08ld][%03d][dlna] %s:%d, "format, \
        (mtos_ticks_get()-ul_stack_start_time)*10, \
