...
#define CG_UPNP_DEVICE_DEFAULT_LEASE_TIME 5//(30 * 60)//(2*60)
...
#define CG_UPNP_DEVICE_M_SEARCH_FILTER_INTERVAL 0
...
typedef enum
{
    DLNA_DEV_STATUS_STOPED = 0,
    DLNA_DEV_STATUS_RUNNING,
} DLNA_DEV_STATUS;
